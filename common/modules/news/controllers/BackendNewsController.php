...
class BackendNewsController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
					[
						...
						{	
							return AdminUsers::isUserHasAccessPermission(self::getUserID(), self::getUserGroup(), 'newsView');
						}
					],
					[
						'allow' => true,
					...
					[
						...
						'matchCallback' => function ($rule, $action) 
						{	
							return AdminUsers::isUserHasAccessPermission(self::getUserID(), self::getUserGroup(), 'newsCreate');
						}
					],
					[
						'allow' => true,
					...
					[
						...
						'matchCallback' => function ($rule, $action) 
						{	
							return AdminUsers::isUserHasAccessPermission(self::getUserID(), self::getUserGroup(), 'newsUpdate');
						}
					],
					[
						'allow' => true,
					...
					[
						...
						'matchCallback' => function ($rule, $action) 
						{	
							return AdminUsers::isUserHasAccessPermission(self::getUserID(), self::getUserGroup(), 'newsDelete');
						}
					],
                ],
    ...
    */
    ...
    public function actionIndex()
    {
		...
		//Get pager count
		$pagerCount = Service::getPagerCount('admin-news');
