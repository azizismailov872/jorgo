...
/* js */
/*$this->registerJsFile(Yii::getAlias('@modules').DIRECTORY_SEPARATOR.'news'.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'news.js', [
