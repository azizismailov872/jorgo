			...
			<div class="x_panel">
				...
				<div class="col-md-12">
					...
					<?= $form->field($searchModel, 'category_id', [
						...
						'labelOptions' => ['class' => 'control-label col-md-1'],
					])->dropDownList($menuCategoriesList, ['id'=>'menu-list', 'prompt'=>Yii::t('form', 'Select'), 'class' => 'form-control col-md-5 col-xs-12']); ?>
				</div>
				<div class="col-md-12">
					...
					<div class="col-sm-12">
						...
						<?= GridView::widget([
							...
							'columns' => [
								...
								'category_name',
								[
									'attribute'=>'parent_menu_name',
									'format'=>'text',//raw, html
									'content'=>function($model)
									{
										return $model->parent_menu_name;
									}
								],
								'name',
								'url',
								[
									...
									'template' => '{status} {update} {delete} {order_up} {order_down}',
									'buttons' => [
